...
public class BugEaterConfigurationType extends CMakeRunConfigurationType implements DumbAware {
    ...
    public BugEaterConfigurationType() {
        super(TYPE_ID, FACTORY_ID, "Debugger-Stub", "Bug-Eater Debugger Stub", NotNullLazyValue.lazy(() -> IconManager.getInstance().getIcon("/icons/bugEaterRunConfig.svg", BugEaterConfigurationType.class)));
    }
